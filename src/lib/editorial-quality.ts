...
const editorialLedgers: Record<string, EditorialLedgerSeed> = {
  ...
  "rohitg00-agentmemory-best-practices-2026-05-13": {
    ...
    factPack: [
      ...
      { claim: "Retrieval benchmark: Agentmemory reports higher recall than BM25-only fallback and outperforms alternatives (mem0, Letta/MemGPT) on LongMemEval-S (ICLR 2025, five hundred questions).", evidence: "README.md comparison table and benchmark directory.", confidence: "medium" },
      { claim: "Token savings reported as substantial compared to pasting full context every session.", evidence: "README.md token savings section.", confidence: "medium" },
  ...
  "github-trending-ai-devtools-2026-05-13": {
    sources: [
      ...
      source('rohitg00/agentmemory', 'https://github.com/rohitg00/agentmemory', 'primary-source', 'GitHub Trending rank two and repository evidence for the daily ranking.'),
      source('obra/superpowers', 'https://github.com/obra/superpowers', 'primary-source', 'GitHub Trending rank three and repository evidence for the daily ranking.'),
      source('yikart/AiToEarn', 'https://github.com/yikart/AiToEarn', 'primary-source', 'GitHub Trending rank four and repository evidence for the daily ranking.'),
      source('millionco/react-doctor', 'https://github.com/millionco/react-doctor', 'primary-source', 'GitHub Trending rank five and repository evidence for the daily ranking.'),
      source('mattpocock/skills', 'https://github.com/mattpocock/skills', 'primary-source', 'GitHub Trending rank six and repository evidence for the daily ranking.'),
      source('rasbt/LLMs-from-scratch', 'https://github.com/rasbt/LLMs-from-scratch', 'primary-source', 'GitHub Trending rank seven and repository evidence for the daily ranking.'),
      source('CloakHQ/CloakBrowser', 'https://github.com/CloakHQ/CloakBrowser', 'primary-source', 'GitHub Trending rank eight and repository evidence for the daily ranking.'),
      source('github/spec-kit', 'https://github.com/github/spec-kit', 'primary-source', 'GitHub Trending rank nine and repository evidence for the daily ranking.'),
    ...
    factPack: [
      { claim: "GitHub Trending returned nineteen repositories for the daily period.", evidence: "https://github.com/trending", confidence: "high" },
      ...
      { claim: "Five eligible repositories were enriched with GitHub metadata; zero repositories were blocked or restricted by editorial risk rules.", evidence: "GitHub repository metadata via https://api.github.com/repos/{owner}/{repo}.", confidence: "high" },
      { claim: "tinyhumansai/openhuman gained one thousand fourteen stars with a total of three thousand five hundred six stars, GPL-3.0 license, last pushed 2026-05-13.", evidence: "GitHub API enrichment for tinyhumansai/openhuman.", confidence: "high" },
      { claim: "rohitg00/agentmemory gained one thousand forty-eight stars with a total of six thousand five hundred thirteen stars, Apache-2.0 license, last pushed 2026-05-12.", evidence: "GitHub API enrichment for rohitg00/agentmemory.", confidence: "high" },
      { claim: "obra/superpowers gained one thousand four hundred nineteen stars with a total of one hundred eighty-eight thousand seven hundred fourteen stars, MIT license, last pushed 2026-05-13.", evidence: "GitHub API enrichment for obra/superpowers.", confidence: "high" },
      { claim: "yikart/AiToEarn gained one thousand two hundred eighty-two stars with a total of twelve thousand four hundred thirteen stars, MIT license, last pushed 2026-05-13.", evidence: "GitHub API enrichment for yikart/AiToEarn.", confidence: "high" },
      { claim: "millionco/react-doctor gained seven hundred eighty-eight stars with a total of six thousand three hundred twenty-seven stars, MIT license, last pushed 2026-05-13.", evidence: "GitHub API enrichment for millionco/react-doctor.", confidence: "high" },
      { claim: "mattpocock/skills gained three thousand eight hundred sixty-seven stars with a total of seventy-five thousand one hundred thirty-three stars, MIT license, last pushed 2026-05-13.", evidence: "GitHub API enrichment for mattpocock/skills.", confidence: "high" },
      { claim: "tinyhumansai/openhuman is a Rust-based personal AI agent harness with token compression and over one hundred integrations. Early beta, GPL-3.0 copyleft.", evidence: "README.md from tinyhumansai/openhuman.", confidence: "high" },
      { claim: "rohitg00/agentmemory provides a four-tier memory consolidation pipeline, over fifty MCP tools, and supports over fifteen agent clients.", evidence: "README.md from rohitg00/agentmemory.", confidence: "high" },
      { claim: "obra/superpowers provides composable skill definitions for AI agent workflows including brainstorming, dispatching parallel agents, systematic debugging, and TDD.", evidence: "README.md from obra/superpowers.", confidence: "high" },
      { claim: "millionco/react-doctor is a React codebase health scanner from the Million.js team (YC W24) with agent skill integration.", evidence: "README.md from millionco/react-doctor.", confidence: "high" },
      { claim: "rasbt/LLMs-from-scratch is a foundational LLM education resource authored by Sebastian Raschka, published by Manning.", evidence: "README.md from rasbt/LLMs-from-scratch.", confidence: "high" },
      { claim: "github/spec-kit gained nearly thirteen hundred stars in one day; a new specification tool from GitHub without enriched metadata.", evidence: "GitHub Trending listing for github/spec-kit.", confidence: "medium" },
    ],
    methodology: [
