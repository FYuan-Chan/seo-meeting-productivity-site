...
export const pages: SeoPage[,
  ...
  },
  {
    ...
    description: 'Download and customize this meeting agenda template to improve your workflow. Includes examples and best practices.',
    eyebrow: 'Template page',
    intro: [
      'This template page provides ready-to-use formats for meeting agenda template.',
      'Templates are evergreen content that attracts consistent search traffic.'
    ],
    targetKeyword: 'meeting agenda template',
    category: 'template',
    monetizationPrimary: 'ads',
    ctaLabel: 'See commercial comparisons',
    ctaHref: '/pages/best-ai-meeting-assistants/',
