    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          '**Claude** is strongest when the workflow depends on careful long-form reasoning, document analysis, and consistent writing style. Anthropic publishes model-family documentation and safety material that are better sources than social-media summaries.',
