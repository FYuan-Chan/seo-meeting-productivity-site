...
export const aiToolPages: SeoPage[] = [
  ...
  },
  {
    ...
    title: 'GitHub Trending AI Dev Tools: May 10, 2026 Ranking and What Deserves Your Attention',
    description:
      'Evidence-based ranking of the top 12 repositories from GitHub Trending on May 10, 2026, with repository facts, trend clusters, and editorial risk handling for AI developer-tool readers.',
    eyebrow: 'GitHub Trending',
    intro: [
    ...
    sections: [
      {
        type: 'paragraphs',
        heading: 'TL;DR: Three signals, not a leaderboard',
        paragraphs: [
      ...
      {
        type: 'table',
        heading: 'GitHub Trending AI Developer Tools: May 10, 2026 Daily Ranking',
        columns: ['Rank', 'Repository', 'Language', 'Stars gained', 'License', 'Editorial handling', 'Signal for builders'],
        rows: [
      ...
      {
        type: 'paragraphs',
        heading: 'Trend Cluster 1: Multimodal agent stacks reaching production maturity',
        paragraphs: [
      ...
      {
        type: 'paragraphs',
        heading: 'Trend Cluster 2: Agent skill standardization for coding workflows',
        paragraphs: [
      ...
      {
        type: 'paragraphs',
        heading: 'Trend Cluster 3: Vertical-domain agents entering regulated industries',
        paragraphs: [
      ...
      {
        type: 'table',
        heading: 'Trend cluster summary',
        columns: ['Cluster', 'Representative repos', 'Signal strength', 'Maturity evidence'],
        rows: [
