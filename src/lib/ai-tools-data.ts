...
export const aiToolPages: SeoPage[] = [
  // ─── 1. ChatGPT vs Claude ───
  {
    ...
    title: 'Claude vs ChatGPT for Coding: Developer Decision Guide for Code Review, Debugging, and IDE Work',
    description:
      'Claude vs ChatGPT for coding compared by developer task: code review, debugging, architecture explanation, IDE workflows, and team adoption checks.',
    ...
    aiToolMeta: {
      ...
      affiliateLinks: [
        { tool: 'ChatGPT', url: 'https://chat.openai.com', label: 'Try ChatGPT' },
        { tool: 'Claude', url: 'https://claude.ai', label: 'Try Claude' },
      ],
      comparisonData: {
        dimensions: ['Writing Quality', 'Coding', 'Reasoning', 'Speed', 'Context Handling', 'Plan Clarity'],
        ratings: {
          ChatGPT: { 'Writing Quality': 8, Coding: 9, Reasoning: 8.5, Speed: 9, 'Context Handling': 7, 'Plan Clarity': 'Check current OpenAI plans' },
          Claude: { 'Writing Quality': 9, Coding: 8, Reasoning: 9, Speed: 8, 'Context Handling': 9.5, 'Plan Clarity': 'Check current Anthropic plans' },
        },
      },
    },
    sections: [
      {
        type: 'table',
        heading: 'Claude vs ChatGPT for coding: quick developer decision map',
        columns: ['Coding task', 'Better default', 'Why it tends to fit', 'How to verify before standardizing'],
        rows: [
          ['Fast bug reproduction, small code snippets, tool-assisted research', 'ChatGPT', 'The workflow benefits from quick iteration, browsing or file/tool workflows, and broad product integrations.', 'Run one real bug from your backlog and check whether the answer shortens the human debug loop.'],
          ['Long pull-request review, architecture notes, refactor planning', 'Claude', 'The workflow benefits from careful explanation, longer narrative continuity, and review-friendly reasoning over a larger context packet.', 'Give both assistants the same repository summary and require source-linked review comments.'],
          ['IDE-adjacent day-to-day coding', 'ChatGPT first, then compare dedicated IDE tools', 'ChatGPT is useful as a general assistant, but many teams should also evaluate Copilot, Cursor, or Claude Code for editor-native work.', 'Measure whether the assistant reduces context switching inside the editor.'],
          ['Design review, migration planning, policy-sensitive analysis', 'Claude', 'Claude is often the more comfortable fit when the output must be cautious, structured, and easy for reviewers to challenge.', 'Ask for assumptions, risks, rollback steps, and unresolved questions before accepting the plan.'],
          ['Mixed product work: code, copy, data, screenshots, research', 'ChatGPT', 'The broader ChatGPT product surface is useful when coding is only one part of a multi-modal work session.', 'Use a task that combines research, code explanation, and a deliverable your team actually ships.'],
        ],
      },
      {
        type: 'paragraphs',
        heading: 'The developer workflow divide: ecosystem speed vs review depth',
        paragraphs: [
      ...
      {
        type: 'tool-cards',
        heading: 'Tool profiles for developer selection',
        tools: [
          {
            name: 'ChatGPT',
            rating: 4.5,
            summary: 'A broad AI assistant ecosystem that works well when coding is mixed with research, data tasks, writing, screenshots, and quick iteration.',
            pros: ['Broad product ecosystem', 'Useful for fast mixed workflows', 'Strong general-purpose coding help', 'Good fit for tool-assisted research'],
            cons: ['Can be overconfident on niche code details', 'Needs source checking for important claims', 'Exact model access and plan limits change', 'Dedicated IDE tools may fit editor-native work better'],
            ctaUrl: 'https://chat.openai.com',
            ctaLabel: 'Check ChatGPT',
            pricing: 'Check current OpenAI plans before buying',
          },
          {
            name: 'Claude',
            rating: 4.4,
            summary: 'Anthropic\'s assistant is often a strong fit for long-form code review, architecture explanation, refactor planning, and careful technical writing.',
            pros: ['Strong long-form reasoning style', 'Review-friendly explanations', 'Good fit for architecture and refactor discussion', 'Often cautious with uncertain output'],
            cons: ['Less useful when the workflow depends on a broad plugin ecosystem', 'No native image-generation workflow', 'Exact model access and plan limits change', 'Still requires human code review'],
            ctaUrl: 'https://claude.ai',
            ctaLabel: 'Check Claude',
            pricing: 'Check current Anthropic plans before buying',
          },
        ],
      },
      {
        type: 'paragraphs',
        heading: 'How to test Claude and ChatGPT on your own repository',
        paragraphs: [
      ...
      },
      {
        ...
        useCases: [
          { scenario: 'Reviewing long repository notes or architecture proposals', recommended: 'Claude', reason: 'Claude is usually the safer fit when the task depends on sustained explanation and careful review language.', icon: '📄' },
          { scenario: 'Quick coding help with research and tool access', recommended: 'ChatGPT', reason: 'ChatGPT is the stronger fit when the workflow moves quickly between coding, research, and general assistant tasks.', icon: '💻' },
          { scenario: 'Debugging a small reproducible issue', recommended: 'ChatGPT', reason: 'Fast iteration and broad assistant workflows can help generate hypotheses, but the final fix still needs source-level review.', icon: '🧩' },
          { scenario: 'Refactor planning or migration review', recommended: 'Claude', reason: 'Claude is often a stronger fit when the answer must be structured, cautious, and easy for a teammate to challenge.', icon: '🛠️' },
          { scenario: 'Team standardization decision', recommended: 'Test both', reason: 'Use real repository tasks, correction count, source traceability, and reviewer confidence instead of a generic winner claim.', icon: '✅' },
          { scenario: 'Mixed product workflow with code, copy, data, and screenshots', recommended: 'ChatGPT', reason: 'The broader product surface is useful when coding is only one part of the session.', icon: '🔌' },
        ],
      },
      {
        type: 'paragraphs',
        heading: 'Fast recommendation for developers',
        paragraphs: [
    ...
    faq: [
      { question: 'Is Claude or ChatGPT better for coding?', answer: 'ChatGPT is usually the better first pick for fast tool-assisted iteration, mixed research, and general assistant workflows. Claude is usually the better first pick for code review, architecture explanation, refactor planning, and careful reasoning over a larger context packet.' },
      { question: 'Should developers choose Claude or ChatGPT from benchmarks alone?', answer: 'No. Benchmarks are useful signals, but team adoption should depend on repository-specific tests, correction count, source traceability, and reviewer confidence.' },
      { question: 'Which assistant is better for code review?', answer: 'Claude is often the stronger default for review-style work because the output tends to be structured and easier to challenge. Important findings still need human review and source-level verification.' },
      { question: 'Which assistant is better for debugging?', answer: 'ChatGPT is often the stronger default for quick debugging loops and tool-assisted research. For complex bugs, compare both assistants on the same reproduction packet and keep only verifiable suggestions.' },
      { question: 'Can a team use both Claude and ChatGPT?', answer: 'Yes. A practical split is ChatGPT for fast mixed workflows and Claude for longer review, planning, and explanation tasks. Teams should document where each assistant is allowed and how outputs are reviewed.' },
      { question: 'How should pricing and model limits be checked?', answer: 'Treat pricing, plan packaging, model names, and limits as refresh-sensitive. Check the current OpenAI and Anthropic documentation before making a buying decision.' },
    ],
