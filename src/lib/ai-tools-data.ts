    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '**Use both for comprehensive research.** A stronger workflow is: 1) use Perplexity to gather current facts and data points, 2) feed those facts to ChatGPT for deeper analysis and synthesis, 3) use downstream tools to create visualizations or reports.',
